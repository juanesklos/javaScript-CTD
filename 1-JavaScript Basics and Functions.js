...
//STRETCH GOAL:
console.log("Q2 STRETCH GOAL-------------Start------------");
let bigNumber15 = 369852147896632;
let bigNumber16 = 36985214789663212;
let bigNumberLonger = 36985214789663214259812358;
console.log("Q2: This is a bigNumber: ", bigNumber15);
console.log("Q2: This is a bigNumber: ", bigNumber16);
console.log("Q2: This is a bigNumber: ", bigNumberLonger);
console.log("Q2 STRETCH GOAL-------------End------------");
console.log();
...
console.log("The variable flagTrue made true is: ", flagTrue);
//The output of the above should be true.
console.log("The variable flagFalse made false is: ", flagFalse);
...
let myInformation = " Hello! My name is " + firstName + " " + lastName + " and I was born in " + country;

// Don't forget your console.logs!
console.log("Q4-------------Start------------");
console.log("The value of myInformation is : " + myInformation);
console.log("Q4-------------End------------");
console.log();


console.log("Q4 STRETCH GOAL-------------Start------------");
let myInformationTemplate = ` Hello! My name is ${firstName} ${lastName} and I was born in ${country}`;
console.log("The value of myInformationTemplate is : " + myInformationTemplate);
console.log("Q4 STRETCH GOAL-------------End------------");
console.log();
...
let addFloatingandInteger = floatingPoint + integer;
let addFIntegerandNegativeInteger = integer + negative;

// Don't forget your console.logs!
console.log("Q5-------------Start------------");
console.log("The value of addFloatingandInteger is : " + addFloatingandInteger);
console.log("The value of addFIntegerandNegativeInteger is : " + addFIntegerandNegativeInteger);
console.log("Q5-------------End------------");
console.log();
...
let lastInitial = firstName.charAt(3);
let capitalize = firstName.toUpperCase();

// Don't forget your console.logs!

console.log("Q6-------------Start------------");
console.log("The length of firstName is : " + length);
console.log("The first Initial of firstName is : " + firstInitial);
console.log("The last letter of firstName is : " + lastInitial);
console.log("The capitalize of firstName is : " + capitalize);
console.log("Q6-------------End------------");
console.log();

//STRETCH GOAL
console.log("Q6 STRETCH GOAL-------------Start------------");
let weirdFirstName = firstName.at(firstName.length - 1);
let weirdLastName = lastName.at(lastName.length - 1);
let weirdInitials = weirdFirstName + weirdLastName;
console.log("The length of weirdInitials is : ", weirdInitials.toUpperCase());
console.log("Q6 STRETCH GOAL-------------End------------");
console.log();
...
console.log("Q7 STRETCH GOAL-------------Start------------");
console.log("The value of answer7 is : " + answer7);
console.log("Q7 STRETCH GOAL-------------End------------");
console.log();
// ---------- QUESTION 8 ----------
...
if (age < 30) {
    ...
    phrase = " you're young at heart!";
}

// Don't forget your console.logs!
//STRETCH GOAL:
console.log(`${firstName}, ${phrase}`);
console.log("Q8-------------End------------");
console.log();
...
if (randomNum === 1) {
    phraseRandom = "It is certain.";
} else if (randomNum === 2) {
    phraseRandom = "Perhaps.";
} else {
    phraseRandom = "Absolutely not.";
}

// Don't forget your console.logs!

console.log("Q9-------------Start------------");
console.log(`This is the number whit if statement: ${randomNum}`);
...
// STRETCH GOAL: 
console.log("Q9 STRETCH GOAL-------------Start------------");
let phraseRandomSwicht;
switch (randomNum) {
    case 1:
        phraseRandomSwicht = "It is certain.";
        break;
    case 2:
        phraseRandomSwicht = "Perhaps.";
        break;
    default:
        phraseRandomSwicht = "Absolutely not.";
}


console.log(`This is the number whit switch statement: ${randomNum}`);
console.log(`${phraseRandomSwicht}`);
console.log("Q9 STRETCH GOAL-------------End------------");
console.log();
...
let exampleNum = 21.4466;
let result = exampleNum.toPrecision(4);
console.log(`This is the rounded number : ${result}`);
...
console.log(`This is the multiply result : ${answer11}`);
console.log("Q11-------------End------------");
console.log();
...
function useParams(capitalWord) {
    let answer = capitalWord.toUpperCase();
    return answer;
}
console.log("Q14: ", useParams("hello"));
console.log("Q14-------------End------------");
...
let word1 = "Juan is the best";
let word2 = "Carlos is a master";

function biggestStringLength(word1Function, word2Function) {
    let long1 = word1Function.length;
    let long2 = word2Function.length;
    let finalLong;
